...
import com.lbytech.lbytech_backend_new.es.NotebookEsRepository;
...
class AliOssUtilTest {
    ...
    @Autowired
    private NotebookEsRepository notebookEsRepository;
    ...
    void syncNotebookToEs() {
        ...
        notebookList.forEach(notebook -> {
            ...
            notebookEsRepository.save(notebookForEs);
